...
import { useGetUnVerifiedCards } from "@/hooks/tansack-query/queries/homepage";
...
const UnverifiedCards = () => {
  ...
  const { unverifiedCards, unverifiedCardsLoading, unverifiedCardsError } = useGetUnVerifiedCards({
    ...
    <PageWrapper showFilter={false} searchPlaceholder="Search by ID, Name, Location" handleSearch={handleSearch}>
      <Breadcrumb className="mb-8">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Unverified Cards</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
              ...
              <TableRow key={`${card.unique_entity_id} ${card.bank_card_id}`}>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem className="cursor-pointer focus:bg-[#54CC001A]">Change Status</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </TableCell>
              </TableRow>
...
export default UnverifiedCards;
